...
module.exports = class AlbumRedMessageCommand extends MessageCommand {
  constructor() {
    super('red', {
      aliases: ['red'],
      category: 'albums',
  ...
  async exec(message) {
    const embedTV = new EmbedBuilder()
      .setColor(11476553)
      .setAuthor({ name: 'Taylor Swift', iconURL: 'https://lhwb.dev/ts.png', url: 'https://en.wikipedia.org/wiki/Red_(Taylor%27s_Version)' })
    ...
    const embed = new EmbedBuilder()
      .setColor(11476553)
      .setAuthor({ name: 'Taylor Swift', iconURL: 'https://lhwb.dev/ts.png', url: 'https://en.wikipedia.org/wiki/Red_(Taylor%27s_Version)' })
      .setThumbnail('https://i.imgur.com/as6dlgi.jpg')
