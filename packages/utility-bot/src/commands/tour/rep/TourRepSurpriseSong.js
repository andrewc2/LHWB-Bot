...
export default class TourRepSurpriseSong extends Command {
  constructor() {
    super('tourRepSurpriseSong', {
      name: 'tour reputation surprise-songs',
      description:
        "Displays the surprise songs from Taylor Swift's reputation Stadium Tour",
      category: 'tours',
    });
  }
  ...
  async exec(interaction) {
    const embedP1 = new EmbedBuilder()
      .setColor(568027)
      .setAuthor({
        name: 'reputation Stadium Tour: Surprise Songs',
