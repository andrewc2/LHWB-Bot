...
export default class AlbumRed extends Command {
  constructor() {
    super('red', {
      name: 'album red',
  ...
  async exec(interaction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setThumbnail('https://cdn.lhwb.dev/i/Red.png')
