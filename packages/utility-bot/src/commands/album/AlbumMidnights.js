...
export default class AlbumMidnights extends Command {
  constructor() {
    super('midnights', {
  ...
  async exec(interaction) {
    ...
    const embed2 = new EmbedBuilder()
      ...
      .setThumbnail('https://cdn.lhwb.dev/i/Midnights.png')
      .setFooter({
        text: 'Page 2 of 3 - Deluxe Edition: 54:42 | 3am Edition: 69:29',
      })
      .setDescription(
        escapeNumberedList(
