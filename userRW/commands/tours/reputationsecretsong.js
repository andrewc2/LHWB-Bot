    ...
    exec(message) {
        if (message.guild != null){
            const embed = new MessageEmbed()
                .setColor(568027)
                .setAuthor("Secret Songs", "https://lhwb.dev/ts.png", "https://docs.google.com/spreadsheets/d/1Yt0_VqcPczB9GxKf9BGCpNcSWXTROlpdrEcTP1wmevs/edit")
                .setThumbnail("https://i.imgur.com/Zhg0oXF.jpg")
                .setDescription("Due to the number of secret songs I've DM'd you the full list!");
