...
class fearlessCommand extends SlashCommand {
    constructor() {
        super('fearless', {
            name: 'album fearless',
            prefixId: "albumfearless",
            category: "albums",
            commandType: "sub",
            parentCommandName: "album",
            shortCommandName: "fearless",
        });
    }
    ...
    async exec(interaction, message) {
		...
		const embedPlat = new MessageEmbed()
			.setColor(14929032)
			.setAuthor({ 
                name: "Taylor Swift", 
                iconURL: "https://lhwb.dev/ts.png", 
		...
		const embedArray = [embedTV, embedPlat, embed];
