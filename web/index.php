            ...
            <div class="container-fluid">
                <div id="commands">
                    ...
                    <ul>
                        ...
                        <li>/track play-count [song]: Displays the play count for the specified song</li>
                        ...
                        <li>/queue remove object:[song]: Removes a song from the queue [Trusted Role Only]</li>
                        ...
                        <li>/tour eras secret-songs: Displays the complete list of The Eras Tour secret songs.</li>
                        ...
                        <li>/livestream: information regarding the stream server.</li>
