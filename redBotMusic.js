...
bot.on('message', function(user, userID, channelID, message, event) {
    ...
    switch(cmd[0].toLowerCase()){
        ...
        case "!taylorswift":
            ...
            break;
        case "!fearless":
            albumFearless(channelID, message, userID,user);
            break;
        case "!speaknow":
            albumSpeakNow(channelID, message, userID,user);
            break;
        case "!red":
            albumRed(channelID, message, userID,user);
            break;
        case "!1989":
            album1989(channelID, message, userID,user);
            break;
        case "!reputation":
            albumreputation(channelID, message, userID,user);
            break;
        case "!lversion":
            if(isMod(channelID,userID))
...
function albumFearless(channelID, message, userID, user) {
    bot.sendMessage({ to:channelID,
        embed: {
...
function albumSpeakNow(channelID, message, userID, user) {
    bot.sendMessage({ to:channelID,
        embed: {
...
function albumRed(channelID, message, userID, user) {
    bot.sendMessage({ to:channelID,
        embed: {
...
function album1989(channelID, message, userID, user) {
    bot.sendMessage({ to:channelID,
        embed: {
...
function albumreputation(channelID, message, userID, user) {
    bot.sendMessage({ to:channelID,
        embed: {
