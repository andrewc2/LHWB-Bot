...
class repSetlistCommand extends Command {
	...
	exec(message) {
		const embed = new MessageEmbed()
			.setColor(568027)
			.setAuthor("Typical reputation Stadium Tour Setlist", "https://lhwb.dev/ts.png", "https://www.setlist.fm/stats/average-setlist/taylor-swift-3bd6bc5c.html?tour=3d0a56f")
