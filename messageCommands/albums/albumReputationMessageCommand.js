...
module.exports = class AlbumReputationMessageCommand extends MessageCommand {
  constructor() {
    super('reputation', {
  ...
  exec(message) {
    const embed = new EmbedBuilder()
      .setColor(12040119)
      .setAuthor({ name: 'Taylor Swift', iconURL: 'https://lhwb.dev/ts.png', url: 'https://en.wikipedia.org/wiki/Reputation_(Taylor_Swift_album)' })
