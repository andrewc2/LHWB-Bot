...
class WT1989GuestsCommand extends Command {
    constructor() {
        super("1989guests", {
            aliases: ["1989guests"],
            category: "tours",
    ...
    exec(message) {
        ...
        const successEmbed = new MessageEmbed()
            .setColor(568027)
            .setAuthor("1989 World Tour: Secret Songs", "https://lhwb.dev/ts.png", "https://en.wikipedia.org/wiki/The_1989_World_Tour#Shows")
            .setThumbnail("https://i.imgur.com/tIO68fu.jpg")

        if (message.guild != null){
            message.channel.send(successEmbed.setDescription("Due to the number of guests I've DM'd you the full list!"));
        }
        message.author.send(successEmbed.addFields(
        ...
        .setFooter('Only North America had special guests')).catch(() => {
...
module.exports = WT1989GuestsCommand;